...
}`,t=await P(c);if(p.push(...t.data.pages.edges.map(s=>s.node)),!t.data.pages.pageInfo.hasNextPage)break;e=t.data.pages.pageInfo.endCursor}return p}var k=`http://scp-wiki.wikidot.com/9000booblesnoot
9966
9006
9886
9116
